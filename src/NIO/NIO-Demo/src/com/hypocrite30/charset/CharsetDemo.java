package com.hypocrite30.charset;
...
public class CharsetDemo {
    public static void main(String[] args) throws CharacterCodingException {
        ...
        encodeBuffer.put("hypocrite30");
        encodeBuffer.flip();
        //4 编码
        ByteBuffer byteBuffer = charsetEncoder.encode(encodeBuffer);
        ...
        byteBuffer.flip();
        CharBuffer charBuffer2 = GBK_charset.decode(byteBuffer);
        System.out.println("使用GBK编码进行解码：");
